...
export const Header: React.FC<HeaderProps> = ({ onRequestStockList }) => {
  ...
  return (
    <>
      ...
      <div className="bg-[#063F35] border-b border-[#071715] text-[10px] sm:text-xs py-1.5 sm:py-2 relative z-[100] pt-safe">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 text-[#DCE8E4]">
          <div className="flex items-center gap-2 sm:gap-6 shrink-0 min-w-0">
            <span className="flex items-center gap-1.5 sm:gap-2 font-bold text-white tracking-wide uppercase text-[10px] sm:text-[11px] whitespace-nowrap">
              <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-[#00A88F] animate-pulse shrink-0" />
              <span className="hidden xs:inline">{t('navigation.topLiveUkStock', 'LIVE UK STOCK UPDATED TODAY')}</span>
              <span className="xs:hidden">LIVE UK STOCK</span>
            </span>
          ...
          <div className="flex items-center gap-2 sm:gap-4 relative z-[100] shrink-0">
            <LanguageSelector />
            <span className="text-[#D4AF62]/50 select-none text-[10px] sm:text-xs">│</span>
            <a
              href="tel:+442080044421"
              className="flex items-center gap-1 font-mono font-bold text-[#DCE8E4] hover:text-[#00A88F] transition-colors text-[10px] sm:text-xs whitespace-nowrap"
            >
              <Phone className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#00A88F] shrink-0" />
      ...
      <header
        ref={headerRef}
        className={`sticky top-0 z-50 w-full text-white header-glass-dark border-b border-[#063F35]/70 transition-all duration-200 ${scrolled ? 'shadow-xl shadow-black/30' : 'shadow-md'
          }`}
      >
        <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-[5.75rem] gap-2 sm:gap-3">
            {/* Mobile / Desktop Logo */}
            <Link to="/" className="flex items-center py-1 shrink-0 -ml-0.5 sm:-ml-4 lg:-ml-6 transition-all">
              <img
                src="/mobiles-wholesale-logo.1-removebg-preview.png"
                alt="Mobiles Wholesale"
                className="h-8 xs:h-9 sm:h-20 lg:h-22 w-auto object-contain transition-transform hover:scale-105 brightness-110 drop-shadow-md origin-left"
              />
            </Link>
            ...
            <nav className="hidden lg:flex items-center gap-0.5 xl:gap-1.5">
              ...
              <Link
                to="/"
                className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${location.pathname === '/'
              ...
              >
                <div className="flex items-center">
                  <Link
                    to="/stock"
                    className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-all whitespace-nowrap ${location.pathname === '/stock' || location.pathname === '/stock-list' || location.pathname === '/stock-offers'
                        ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                        : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                      }`}
                  >
                    ...
                    <div className="bg-[#071715] border border-[#063F35] rounded-xl shadow-2xl p-2 grid gap-0.5">
                      {liveStockLinks.map((item) => (
                        <Link
                          key={item.path}
                          to={item.path}
                          className={`px-3 py-2 rounded-lg text-xs font-semibold transition-all ${location.pathname === item.path
              ...
              >
                <Link
                  to="/wholesale"
                  className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-all whitespace-nowrap ${location.pathname.startsWith('/wholesale') || location.pathname === '/iphones' || location.pathname === '/samsungs' || location.pathname === '/google-pixel'
                      ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                      : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                    }`}
                >
                          ...
                          <div className="grid gap-0.5">
                            {buyingWholesaleLinks.map((item) => (
                              <Link
                                key={item.path}
                                to={item.path}
                                className={`px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all ${location.pathname === item.path
                                    ? 'text-[#D4AF62] bg-[#D4AF62]/10 font-bold'
                                    : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                                  }`}
                              >
              ...
              >
                <button
                  type="button"
                  className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-all whitespace-nowrap ${location.pathname.startsWith('/services') || location.pathname === '/sell-to-us'
                      ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                      : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                    }`}
                >
              ...
              >
                <button
                  type="button"
                  className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-all whitespace-nowrap ${location.pathname === '/grading' || location.pathname === '/how-we-grade' || location.pathname === '/warranty-and-returns' || location.pathname === '/faqs' || location.pathname === '/about'
                      ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                      : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                    }`}
                >
              ...
              >
                <button
                  type="button"
                  className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold flex items-center gap-1 transition-all whitespace-nowrap ${location.pathname === '/corporate' || location.pathname === '/education' || location.pathname === '/retail'
                      ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                      : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                    }`}
                >
              ...
              <Link
                ...
                className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${location.pathname === '/trade-application' || location.pathname === '/business'
                    ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                    : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                  }`}
              >
              ...
              <Link
                to="/contact"
                className={`px-2 xl:px-2.5 py-2 rounded-lg text-xs font-bold transition-all whitespace-nowrap ${location.pathname === '/contact'
                    ? 'text-[#D4AF62] bg-[#D4AF62]/10 border-b-2 border-[#D4AF62] font-black'
                    : 'text-[#DCE8E4] hover:text-white hover:bg-white/5'
                  }`}
              >
            ...
            {/* Header Action CTAs & Mobile Controls */}
            <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-2.5 shrink-0 ml-auto sm:ml-0">
              {/* Cart Badge Button */}
              <Link
                to="/cart"
                aria-label="View Quotation Cart"
                className="relative w-10 h-10 sm:w-11 sm:h-11 rounded-xl text-[#DCE8E4] hover:text-white bg-white/5 border border-[#063F35] hover:border-[#D4AF62] transition-all flex items-center justify-center shrink-0"
                title="View Quotation Cart"
              >
                <ShoppingBag className="w-4 h-4 xs:w-5 xs:h-5 text-[#D4AF62]" />
                {totalItems > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#00A88F] text-white text-[9px] font-black w-4.5 h-4.5 rounded-full flex items-center justify-center border border-[#071715] shadow-xs animate-pulse">
                    {totalItems}
                  </span>
                )}
              </Link>
              ...
              <button
                ...
                className="lg:hidden w-10 h-10 sm:w-11 sm:h-11 flex items-center justify-center text-[#DCE8E4] rounded-xl hover:bg-white/10 border border-[#063F35] shrink-0"
              >
        ...
        {open && (
          <nav className="lg:hidden p-4 pb-[calc(1.5rem+env(safe-area-inset-bottom))] bg-[#071715] border-t border-[#063F35] grid gap-2 shadow-2xl max-h-[85vh] overflow-y-auto">
            {/* Home */}
            <Link
              to="/"
              onClick={() => setOpen(false)}
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${location.pathname === '/' ? 'text-[#D4AF62] bg-[#D4AF62]/10' : 'text-[#DCE8E4] hover:bg-white/5'
                }`}
            >
              {t('navigation.home', 'Home')}
            </Link>
            ...
            <Link
              to="/trade-application"
              onClick={() => setOpen(false)}
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all border-t border-[#063F35] mt-1 ${location.pathname === '/trade-application' || location.pathname === '/business' ? 'text-[#D4AF62] bg-[#D4AF62]/10' : 'text-[#DCE8E4] hover:bg-white/5'
                }`}
            >
              {t('navigation.tradeApplication', 'Trade Application')}
            </Link>
            ...
            <Link
              to="/contact"
              onClick={() => setOpen(false)}
              className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all ${location.pathname === '/contact' ? 'text-[#D4AF62] bg-[#D4AF62]/10' : 'text-[#DCE8E4] hover:bg-white/5'
                }`}
            >
              {t('navigation.contact', 'Contact')}
            </Link>
